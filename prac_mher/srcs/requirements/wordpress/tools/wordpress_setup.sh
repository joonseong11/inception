...
if [ ! -f "/var/www/html/wordpress/index.php" ]; then
  ...
  wp core install --url=https://jujeon.42.fr --title="Jujeon" --admin_user=$WORDPRESS_USER --admin_password=$WORDPRESS_PASSWORD --admin_email=$WORDPRESS_DB_ADMIN_EMAIL --skip-email --allow-root
fi
